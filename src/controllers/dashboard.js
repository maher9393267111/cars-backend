...
const getVendorAnalytics = async (req, res) => {
  ...
  //   success: true,
  //   data: {
  //     bestSellingProducts: [], // No products
  //     dailyEarning: 123,
  //     dailyOrders: 0,
  //     totalProducts: 0,
  //     totalPendingOrders: 0,
  //     salesReport: Array(12).fill(0), // 12 months of zero sales
  //     ordersReport: Array(5).fill(0), // Placeholder for order statuses
  //     incomeReport: {
  //       week: Array(7).fill(0), // 7 days of zero income
  //       month: Array(new Date().getDate()).fill(0), // Current month days
  //       year: Array(12).fill(0), // 12 months of zero income
  //     },
